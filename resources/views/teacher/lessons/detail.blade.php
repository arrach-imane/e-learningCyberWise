...
<div class="container">
    <div class="col-12">
        <div class="card mt-5">
            <div class="card-body">
                <h4 class="header-title">Detail Lessons</h4>
                <form class="needs-validation">
                    <div class="form-row">
                        <div class="col-md-4 mb-4">
                            <label>Choose Lessons</label>
                            <select name="course_id" class="custom-select h-75 d-inline-block" readonly>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="lesson_duration" value="{{ $lesson->lesson_duration }}" type="number" class="form-control"
                                    id="validationCustom02" placeholder="duration" readonly>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
