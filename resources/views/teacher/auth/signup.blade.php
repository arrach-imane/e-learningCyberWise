    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box ptb--40">
                <form action="{{ url('teacher-signup') }}" method="post">
                    @csrf
                    ...
                    <div class="login-form-body">
                        <div class="form-gp">
                            ...
                            <input type="text" id="exampleInputName1" name="full_name" required>
                            <i class="ti-user"></i>
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted">Don't have an account? <a href="{{ url('teacher-login') }}">Sign in</a></p>
                        </div>
                    </div>
                </form>
            </div>
