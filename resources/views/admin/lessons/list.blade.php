...
@section('content')
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="dropdown ml-3">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ url('admin/lessons-add') }}" class="dropdown-item">
                                                ...
                                                <tr data-id="{{ $lesson->lesson_id }}">
                                                    ...
                                                    <td>
                                                        <ul class="d-flex justify-content-center">
                                                            <li class="mr-3">
                                                                <a href="{{ url('admin/lessons/detail', ['id' => $lesson->lesson_id]) }}"
                                                                    class="text-info">
                                                            ...
                                                            <li class="mr-3">
                                                                <a href="{{ url('admin/lessons/update', ['id' => $lesson->lesson_id]) }}"
                                                                    class="text-primary">
                                                                    <div class="icon-container">
    ...
    <script>
        var globalUrl = '{{ route('admin.lessons.delete') }}';
    </script>
@endsection
