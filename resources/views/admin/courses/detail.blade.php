                ...
                <form class="needs-validation">
                    <div class="form-row">
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <select name="category_id" class="custom-select h-75 d-inline-block" {{ auth()->user()->role == 'admin' ? '' : 'disabled' }}>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <select name="course_visibility" class="custom-select h-75 d-inline-block" {{ auth()->user()->role == 'admin' ? '' : 'disabled' }}>
