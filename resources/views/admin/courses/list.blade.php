...
@section('content')
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="dropdown ml-3">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ url('admin/course-add') }}" class="dropdown-item">
                                        ...
                                        <tbody>
                                            @foreach ($courses as $course)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ url('admin/course/detail', ['id' => $course->course_id]) }}">
                                                            <img class="img-fluid px-2" style="width: 50px;"
                                                    ...
                                                    <td>
                                                        <ul class="d-flex justify-content-center">
                                                            <li class="mr-3">
                                                                <a href="{{ url('admin/course/detail', ['id' => $course->course_id]) }}"
                                                                    class="text-info">
                                                            ...
                                                            <li class="mr-3">
                                                                <a href="{{ url('admin/course/update', ['id' => $course->course_id]) }}"
                                                                    class="text-primary">
                                                                    <div class="icon-container">
    ...
    <script>
        var globalUrl = '{{ route('admin.courses.delete') }}';
    </script>
@endsection
